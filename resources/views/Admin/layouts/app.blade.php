<?php
$pengaduan = \App\COnsole\Helper::message();
?>
<!doctype html>
                ...
                <div class="header-menu">
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="message" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="count bg-primary">{{$pengaduan->count()}}</span>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="message">
                                <p class="red">You have {{$pengaduan->count()}} Mails</p>
								@if(isset($pengaduan))
									@foreach($pengaduan as $p)
                                <a class="dropdown-item media" href="#">
                                    <div class="message media-body">
                                        <span class="name float-left">{{$p->nama}}</span>
                                        <!--<span class="time float-right">5 minutes ago</span>-->
                                        <p>{{substr($p->isi_pengaduan, 0, 50)}}</p>
                                    </div>
                                </a>
								@endforeach
								@endif
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            @if(\App\Console\Helper::get_profile()->foto == NULL)
								<img class="user-avatar rounded-circle" src="{!! asset('assets/images/avatar/1.jpg') !!}" alt="User Avatar">
							@else
								<img class="user-avatar rounded-circle" src="{!! asset('assets/images/pengguna/'.\App\Console\Helper::get_profile()->foto) !!}" alt="{{\App\Console\Helper::get_profile()->nama}}">
							@endif
						</a>
